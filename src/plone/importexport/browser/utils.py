            ...
            for data in data_list:
                for key in data.keys():
                    ...
                    if isinstance(data[key],(dict,list)):
                        ...
                        if isinstance(data[key],dict) and data[key].get('download',None):
                            # pdb.set_trace()

                            file_path = data['path']
                            relative_filepath = os.path.join(*file_path.split('/')[1:])
